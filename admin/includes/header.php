...
<head>
    ...
    <style>
        ...
        .ql-toolbar.ql-snow {
            ...
            display: flex;
            flex-wrap: wrap; /* responsive: wrap toolbar buttons on mobile */
        }
...
<body class="bg-[#003355] text-white min-h-screen overflow-x-hidden flex flex-col">
    ...
    <div class="flex flex-col min-h-screen relative z-10">
        ...
        <!-- Mobile-only Top Bar -->
        <div class="md:hidden sticky top-0 z-30 w-full flex items-center justify-between p-4 bg-[#001a2d]/90 backdrop-blur-2xl border-b border-white/10">
        ...
        <main class="flex-1 w-full md:pl-80 p-4 sm:p-6 md:py-8 md:pr-8 min-h-screen flex flex-col relative z-10 transition-all duration-300">
        ...
        <header class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 md:p-6 flex flex-wrap gap-4 justify-between items-center mb-6 md:mb-8 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
            ...
            <a href="logout.php" class="flex items-center gap-2 px-4 py-2.5 bg-white/5 hover:bg-red-500/20 border border-white/10 hover:border-red-500/50 text-white/80 hover:text-red-400 hover:shadow-[0_0_15px_rgba(239,68,68,0.2)] rounded-xl transition-all font-medium text-sm whitespace-nowrap">
