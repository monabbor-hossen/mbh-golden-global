    ...
    <div class="flex min-h-screen relative z-10">
        ...
        <aside class="w-64 fixed top-6 left-6 bottom-6 rounded-3xl bg-white/10 backdrop-blur-2xl border border-white/20 shadow-[0_0_30px_rgba(0,130,202,0.15)] flex flex-col z-20">
            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4 flex flex-col gap-2">
                ...
                <a href="packages.php" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-brand-cyan/20 to-transparent border border-brand-cyan/30 text-white shadow-[0_0_15px_rgba(0,130,202,0.2)] transition-all">
                    <i data-lucide="package" class="w-5 h-5 text-brand-cyan"></i>
                                        ...
                                        <tr class="hover:bg-white/5 transition-colors group">
                                            ...
                                            <td class="py-4 px-6 text-sm border-b border-white/5 group-last:border-none">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <a href="?action=delete&id=<?php echo $pkg['id']; ?>" onclick="return confirm('Delete this package?')" class="text-red-400 hover:text-red-300 transition-colors p-2 hover:bg-red-500/20 rounded-lg inline-block">
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 max-w-3xl shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="category_id" class="w-full px-4 py-3 bg-[#002b48] border border-white/10 rounded-xl text-white focus:outline-none focus:border-brand-cyan focus:ring-1 focus:ring-brand-cyan transition-all appearance-none">
